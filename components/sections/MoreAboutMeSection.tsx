    ...
    <section className="min-h-[100svh] lg:h-screen w-full lg:w-[160vw] xl:w-[140vw] shrink-0 relative flex flex-col justify-center bg-[#f4f4f0] border-r border-[#121212]/10 px-6 lg:px-20 py-24 lg:py-0 text-[#121212] overflow-x-hidden lg:overflow-hidden">
      ...
      <div className="relative z-10 w-full flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
        ...
        <div className="flex flex-col flex-1 w-full max-w-4xl relative">
          ...
          <h2 className="relative z-10 font-sans font-black text-[12vw] sm:text-[8vw] lg:text-[5vw] xl:text-[6vw] leading-[0.85] tracking-tighter uppercase text-[#121212] mb-6 lg:mb-8">
            A little more <br/>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="bg-white border-[3px] border-[#121212] shadow-[4px_4px_0px_#121212] md:shadow-[6px_6px_0px_#121212] p-5 lg:p-6 rounded-xl flex flex-col gap-3 transform transition-transform hover:-translate-y-1">
              <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-[var(--pink)] border-[2px] border-[#121212] flex items-center justify-center font-bold text-sm lg:text-lg mb-1">1</div>
              <p className="font-sans font-semibold text-xs lg:text-sm xl:text-base leading-snug">
            ...
            <div className="bg-[var(--blue)] text-white border-[3px] border-[#121212] shadow-[4px_4px_0px_#121212] md:shadow-[6px_6px_0px_#121212] p-5 lg:p-6 rounded-xl flex flex-col gap-3 transform transition-transform hover:-translate-y-1">
              <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-white text-[#121212] border-[2px] border-[#121212] flex items-center justify-center font-bold text-sm lg:text-lg mb-1">2</div>
              <p className="font-sans font-bold text-xs lg:text-sm xl:text-base leading-snug">
                I’m also interested in business and digital marketing, which helps me think beyond the technical side.
              </p>
              <p className="font-sans text-xs lg:text-sm xl:text-base leading-snug text-white/90">
                I like understanding what users and clients actually need, and turning that into something simple, functional, and useful.
              </p>
            </div>

            <div className="md:col-span-2 bg-[#121212] text-white border-[3px] border-[#121212] shadow-[4px_4px_0px_#121212] md:shadow-[6px_6px_0px_#121212] p-5 lg:p-6 rounded-xl flex flex-col lg:flex-row gap-6 items-center justify-between transform transition-transform hover:-translate-y-1">
              <div className="flex-1">
                <span className="font-mono text-[9px] lg:text-[10px] tracking-widest text-[var(--acid)] uppercase mb-2 block">AI & Consistency</span>
                <p className="font-sans font-semibold text-xs lg:text-sm xl:text-base leading-snug mt-1">
                ...
                <div className="w-12 h-[2px] bg-white/20 my-3"></div>
                <p className="font-sans text-xs lg:text-sm xl:text-base leading-snug text-white/80">
                  Consistency is a big part of how I work. I may not be the fastest, but I keep improving, step by step.
                </p>
              </div>
              <div className="w-20 h-20 lg:w-24 lg:h-24 shrink-0 rounded-full border-[2px] border-[var(--acid)] border-dashed animate-[spin_10s_linear_infinite] flex items-center justify-center">
                 <div className="w-14 h-14 lg:w-16 lg:h-16 bg-[var(--acid)] rounded-full flex items-center justify-center text-[#121212] font-black italic text-sm lg:text-base">
                   +1%
                 </div>
              </div>
            </div>
        ...
        <div className="flex flex-col flex-1 w-full max-w-2xl lg:max-w-xl relative">
          ...
          <h2 className="relative z-10 font-sans font-black text-[10vw] sm:text-[6vw] lg:text-[4vw] xl:text-[4.5vw] leading-[0.85] tracking-tighter uppercase text-[#121212] mb-6 lg:mb-8">
            What I&apos;m <br/>
            <span className="bg-[#121212] text-white px-2 py-1 inline-block mt-1 lg:mt-2 relative z-10">Looking for</span>
          </h2>

          <div className="bg-[#ffd400] border-[3px] border-[#121212] shadow-[6px_6px_0px_#121212] lg:shadow-[8px_8px_0px_#121212] p-6 lg:p-8 rounded-2xl relative">
            {/* Tape detail */}
            <div className="absolute -top-3 lg:-top-4 left-1/2 -translate-x-1/2 w-24 lg:w-32 h-6 lg:h-8 bg-white/40 backdrop-blur-sm transform rotate-[-2deg] border border-[#121212]/10 shadow-sm"></div>

            <p className="font-sans font-black text-base lg:text-lg xl:text-xl leading-tight text-[#121212] mb-4 lg:mb-6 tracking-tight uppercase">
            ...
            <div className="w-full h-[2px] lg:h-[3px] bg-[#121212] mb-4 lg:mb-6"></div>
            
            <p className="font-sans font-bold text-xs lg:text-sm xl:text-base leading-snug text-[#121212]/80">
